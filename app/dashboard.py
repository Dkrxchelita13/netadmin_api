    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <button
                class="nav-button admin-only"
                data-view="auditoria"
                onclick="cambiarVista('auditoria', this)"
            >
                <span class="nav-icon">✓</span>
                <span>Auditoría</span>
            </button>
            ...
            <section id="view-auditoria" class="view">
                ...
                <div class="page-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Registro de eventos y operaciones realizadas en NetAdmin.
                        </p>
                    </div>
                ...
                <article class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="toolbar">
                            ...
                            <span id="contadorAuditoria" class="badge badge-info">
                                0 eventos
                            </span>
                            ...
                            <table>
                                ...
                                <tbody id="tablaAuditoria">
                                    <tr>
                                        <td colspan="8">
                                            <div class="empty-state">
                                                <strong>Auditoría no cargada</strong>
                                                Presiona “Actualizar auditoría”.
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
...
<script>
    ...
    async function cargarAuditoria() {
        ...
        try {
            auditoria = await solicitarConToken("/auditoria");
    ...
    function renderizarAuditoria(lista) {
                ...
                <tr>
                    <td colspan="8">
                        <div class="empty-state">
                            ...
                            La auditoría del sistema está vacía.
                        </div>
                    </td>
                </tr>
            `;
        ...
        lista.forEach(evento => {
            tabla.innerHTML += `
                <tr>
                    <td>${escaparHTML(evento.id)}</td>

                    <td>
                        <strong>${escaparHTML(evento.usuario)}</strong>
                    </td>

                    <td>
                        <span class="badge badge-info">
                            ${escaparHTML(evento.rol)}
                        </span>
                    </td>
                    ...
                    <td>
                        <span class="badge ${obtenerClaseAccion(evento.accion)}">
                            ${escaparHTML(evento.accion)}
                        </span>
                    </td>

                    <td>${escaparHTML(evento.ip)}</td>

                    <td>
                        <span class="badge ${obtenerClaseResultado(evento.resultado)}">
                            ${escaparHTML(evento.resultado)}
                        </span>
                    </td>

                    <td>${escaparHTML(evento.fecha)}</td>
                </tr>
            `;
        });
    }
